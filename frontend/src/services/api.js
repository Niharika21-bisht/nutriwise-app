// NutriWise API Client & 7-Day Weekly Diet Plan with Equivalent Meal Alternatives
...
// 7-Day Next Week Diet Plan with Multiple Equivalent Options per Meal
export async function fetchDietPlan(profile) {
  ...
  // Helper to build a meal slot with 3-4 equivalent macro-matched options
    ...
    // DAY 1 - MONDAY
    {
      ...
      meals: [
        createMealSlot(
          ...
          [
            {
              title: "Moong Dal Cheela with Grated Paneer & Mint Dip",
              description: "Savory lentil crepes stuffed with spiced cottage cheese.",
              calories: 325, protein_g: 16.5, carbs_g: 38.0, fat_g: 9.0, prep_time: "18 mins",
              ingredients: ["Yellow Moong Batter", "Cottage Cheese", "Spinach", "Mint Chutney"]
            },
            {
              title: "Overnight Rolled Oats with Almond Milk, Chia Seeds & Sliced Apple",
              description: "Soluble beta-glucan rich oats supporting sustained morning focus.",
              calories: 315, protein_g: 11.0, carbs_g: 52.0, fat_g: 6.5, prep_time: "5 mins",
              ingredients: ["Rolled Oats", "Almond Milk", "Chia Seeds", "Fresh Apples"]
            },
            {
              title: isEggetarian ? "Double Egg Bhurji with 2 Multigrain Toasts" : "Paneer Bhurji Open Toast on Sourdough",
              description: "High-density bioavailable protein breakfast kickstart.",
              calories: 340, protein_g: 19.0, carbs_g: 28.0, fat_g: 14.0, prep_time: "12 mins",
              ingredients: ["Farm Eggs / Paneer", "Whole Wheat Toast", "Onions & Tomatoes"]
            }
          ]
        ),
        createMealSlot(
          ...
          [
            {
              title: "Rajma Masala (Kidney Beans) + Steamed Brown Rice & Beetroot Raita",
              description: "Slow-digesting complex carbs and plant protein rich in folate.",
              calories: 495, protein_g: 19.0, carbs_g: 82.0, fat_g: 9.0, prep_time: "25 mins",
              ingredients: ["Red Kidney Beans", "Brown Rice", "Beetroot Raita", "Kachumber"]
            },
            {
              title: "Chole (Spiced Chickpeas) with 2 Multigrain Phulkas & Green Salad",
              description: "Plant-powered legume bowl packed with zinc and soluble fiber.",
              calories: 470, protein_g: 17.5, carbs_g: 74.0, fat_g: 10.5, prep_time: "20 mins",
              ingredients: ["Kabuli Chana", "Multigrain Rotis", "Tomato Gravy", "Cucumber Salad"]
            },
            {
              title: "Soya Chunk Curry with Steamed Basmati Rice & Roasted Papad",
              description: "Ultra high-protein plant thali with complete essential amino acids.",
              calories: 460, protein_g: 26.0, carbs_g: 68.0, fat_g: 8.0, prep_time: "20 mins",
              ingredients: ["Nutri Soya Chunks", "Basmati Rice", "Onion Tomato Masala", "Curd"]
            }
          ]
        ),
        createMealSlot(
          ...
          [
            {
              title: "Roasted Fox Nuts (Makhana) with Soaked Almonds & Walnuts",
              description: "Magnesium-dense crunchy snack paired with heart-healthy omega-3s.",
              calories: 180, protein_g: 6.5, carbs_g: 22.0, fat_g: 8.0, prep_time: "5 mins",
              ingredients: ["Fox Nuts (Makhana)", "Almonds (5 pcs)", "Walnuts (2 pcs)", "Pink Salt"]
            },
            {
              title: "Sprouted Moong & Pomegranate Chaat with Lemon Dressing",
              description: "Live enzyme rich sprouted legumes delivering bioavailable Vitamin C.",
              calories: 175, protein_g: 9.5, carbs_g: 28.0, fat_g: 2.0, prep_time: "5 mins",
              ingredients: ["Sprouted Green Moong", "Pomegranate Seeds", "Lemon Juice", "Chaat Masala"]
            },
            {
              title: "Probiotic Greek Yogurt / Low-fat Curd with Chia Seeds & Honey",
              description: "Cooling protein snack supporting gut microbiome flora.",
              calories: 165, protein_g: 12.0, carbs_g: 18.0, fat_g: 3.5, prep_time: "3 mins",
              ingredients: ["Greek Yogurt / Dahi", "Chia Seeds", "Raw Honey (1 tsp)"]
            }
          ]
        ),
        createMealSlot(
          ...
          [
            {
              title: "Palak Paneer (Spinach Cottage Cheese) with 2 Rotis & Salad",
              description: "Antioxidant-dense spinach combined with muscle-building paneer.",
              calories: 420, protein_g: 21.5, carbs_g: 42.0, fat_g: 16.0, prep_time: "20 mins",
              ingredients: ["Fresh Spinach", "Paneer Cubes (120g)", "Phulkas (2)", "Green Salad"]
            },
            {
              title: "Moong Dal Khichdi + Grilled Paneer Tikka (4 pcs)",
              description: "Soothing tridoshic comfort dinner with balanced amino acids.",
              calories: 410, protein_g: 20.0, carbs_g: 52.0, fat_g: 11.5, prep_time: "22 mins",
              ingredients: ["Yellow Moong Dal", "Rice", "Paneer Tikka", "A2 Cow Ghee"]
            },
            {
              title: "Soya Chunk & Vegetable Stir-Fry with 2 Rotis & Clear Soup",
              description: "Thermogenic high-protein dinner optimizing cellular recovery.",
              calories: 395, protein_g: 24.0, carbs_g: 44.0, fat_g: 9.5, prep_time: "18 mins",
              ingredients: ["Soya Chunks", "Bell Peppers & Broccoli", "Multigrain Rotis", "Warm Broth"]
            }
          ]
        )
      ]
    ...
    // DAY 2 - TUESDAY
    {
      ...
      meals: [
        createMealSlot(
          ...
          [
            {
              title: "Multigrain Poha with Roasted Peanuts & Sprouts",
              description: "Wholesome flattened rice bursting with natural B-vitamins.",
              calories: 330, protein_g: 12.0, carbs_g: 52.0, fat_g: 8.0, prep_time: "15 mins",
              ingredients: ["Poha", "Green Moong Sprouts", "Peanuts", "Lemon"]
            },
            {
              title: "Rolled Oats Upma Loaded with Carrots, Beans & Green Peas",
              description: "Fiber-rich oats cooked in Indian savory temper.",
              calories: 320, protein_g: 11.5, carbs_g: 48.0, fat_g: 7.0, prep_time: "15 mins",
              ingredients: ["Rolled Oats", "Carrots & Beans", "Mustard Seeds", "Curry Leaves"]
            }
          ]
        ),
        createMealSlot(
          ...
          [
            {
              title: "Dal Makhani (Light Prep) + 2 Multigrain Phulkas & Salad",
              description: "Slow-cooked black lentils rich in polyphenols and sustained energy.",
              calories: 490, protein_g: 18.5, carbs_g: 68.0, fat_g: 14.0, prep_time: "25 mins",
              ingredients: ["Black Urad Dal", "Multigrain Rotis", "Tomato Gravy", "Kachumber"]
            },
            {
              title: "Paneer Matar Curry with Steamed Basmati Rice & Cucumber Raita",
              description: "Classic cottage cheese and green pea thali providing balanced macros.",
              calories: 505, protein_g: 21.0, carbs_g: 70.0, fat_g: 15.0, prep_time: "22 mins",
              ingredients: ["Paneer Cubes", "Green Peas", "Basmati Rice", "Curd Raita"]
            }
          ]
        ),
        createMealSlot(
          ...
          [
            {
              title: "Mixed Fruit Bowl (Apple, Pomegranate & Kiwi) + Pumpkin Seeds",
              description: "Vibrant antioxidant shield protecting cellular health.",
              calories: 170, protein_g: 4.5, carbs_g: 36.0, fat_g: 3.0, prep_time: "5 mins",
              ingredients: ["Apple slices", "Pomegranate", "Kiwi", "Pumpkin Seeds"]
            },
            {
              title: "Dry Roasted Chana with Lemon Juice & Chaat Masala",
              description: "Low-glycemic crunchy legumes preventing sugar dips.",
              calories: 185, protein_g: 9.0, carbs_g: 30.0, fat_g: 3.5, prep_time: "3 mins",
              ingredients: ["Roasted Bengal Gram", "Lemon", "Chaat Masala"]
            }
          ]
        ),
        createMealSlot(
          ...
          [
            {
              ...
              description: "Light spiced scrambled paneer with high calcium and protein.",
      ...
      meals: [
        createMealSlot(
          ...
          [
            ...
            {
              title: "Overnight Rolled Oats with Chia Seeds, Almond Milk & Blueberries",
              description: "Antioxidant-rich whole grains supporting sustained energy.",
              calories: 310, protein_g: 11.0, carbs_g: 50.0, fat_g: 6.0, prep_time: "5 mins",
              ingredients: ["Rolled Oats", "Blueberries", "Chia Seeds", "Almond Milk"]
            }
          ]
        ),
        createMealSlot(
          ...
          [
            {
              title: "Dal Tadka with Steamed Basmati Rice & Bhindi Masala",
      ...
      meals: [
        createMealSlot(
          ...
          [
            ...
            {
              title: "Organic Rolled Oats with Chia Seeds & Sliced Banana",
